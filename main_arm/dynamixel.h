...
public:
	dynamixel();
	~dynamixel();
	void move(int pos, int id, int speed, int acc);
...
#define COMM_RXCORRUPT		(7)
	...
	void __stdcall syncWrite(int id1, int id2, int address, int value1, int value2);


	void __stdcall dxl_write_wordd(int id, int address, int value);
